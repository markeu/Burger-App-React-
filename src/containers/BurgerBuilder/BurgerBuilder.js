...
const mapDispatchToProps = dispatch => {
    return {
        onIngredientsAdded: (igName) => dispatch(burgerBuilderActions.addIngredients(igName)),
        onIngredientsRemoved: (igName) => dispatch(burgerBuilderActions.removeIngredients(igName))
    }
}
